...
ms.locfileid: "887836"
---
# <a name="export"></a><span data-ttu-id="eed4a-103">Export</span><span class="sxs-lookup"><span data-stu-id="eed4a-103">Export</span></span>

> [!IMPORTANT]
> <span data-ttu-id="eed4a-104">Esta página está en desarrollo.</span><span class="sxs-lookup"><span data-stu-id="eed4a-104">This page is under development.</span></span>

## <a name="export-all-products"></a><span data-ttu-id="eed4a-105">Exportar todos los productos</span><span class="sxs-lookup"><span data-stu-id="eed4a-105">Export All Products</span></span>
<span data-ttu-id="eed4a-106">Exportar todos los productos sin filtros.</span><span class="sxs-lookup"><span data-stu-id="eed4a-106">Export all products without any filters.</span></span>

> [!div class="nextstepaction"]
> [<span data-ttu-id="eed4a-107">Exportar todos los productos</span><span class="sxs-lookup"><span data-stu-id="eed4a-107">Export All Products</span></span>](https://app-omaha-prod.azurewebsites.net/api/PublishedListings/Export)

## <a name="export-products-by-category"></a><span data-ttu-id="eed4a-108">Exportar productos por categoría</span><span class="sxs-lookup"><span data-stu-id="eed4a-108">Export Products by Category</span></span>
<span data-ttu-id="eed4a-109">Seleccione una agrupación para exportar:</span><span class="sxs-lookup"><span data-stu-id="eed4a-109">Select a grouping to export:</span></span>
...
## <a name="export-products-by-end-of-support-year"></a><span data-ttu-id="eed4a-167">Exportar productos por el final del año de asistencia</span><span class="sxs-lookup"><span data-stu-id="eed4a-167">Export Products by End of Support Year</span></span>
<span data-ttu-id="eed4a-168">Seleccione un año para exportar el servicio de finalización de productos en ese año:</span><span class="sxs-lookup"><span data-stu-id="eed4a-168">Select a year to export products ending service in that year:</span></span>
