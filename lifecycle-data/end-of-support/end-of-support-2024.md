...
| [Almacenamiento de datos paralelos de Microsoft SQL Server 2012 (Analytics Platform System)](/lifecycle/products/microsoft-sql-server-2012-parallel-data-warehouse-analytics-platform-system?branch=live)<br>[Windows Server 2012, actualización de seguridad extendida del año 1](/lifecycle/products/windows-server-2012?branch=live)<br>[Windows Server 2012 R2, actualización de seguridad extendida del año 1](/lifecycle/products/windows-server-2012-r2?branch=live)<br> | 8 de octubre de 2024 |
| [Windows Embedded POSReady 7, actualización de seguridad extendida del año 3*](/lifecycle/products/windows-embedded-posready-7?branch=live)<br> | lunes, 14 de octubre de 2024 |
